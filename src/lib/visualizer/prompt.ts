 ...
 */
const SCALE_ANCHORS =
  "For scale, use what is in the photo: an exterior door is about 36 inches (0.9 m) wide, a railing is 36 to 42 inches (1 m) tall, a lounge chair is about 6 feet (1.8 m) long. Image 2 is a small sample, not the whole floor: a typical deck is two to four roll widths across and shows the pattern repeated many times.";
