 ...
 *
 * v6.2: Hansberry's chevron is carried by board-to-board colour contrast
 * (pale tan next to deep red-brown), not by seam lines like Boardwalk's,
 * and "even and consistent" was averaging that contrast into one muddy
 * wash — the chevron survived only as faint streaks. Consistency now
 * applies to scale, and a design's hint may describe how its boards
 * differ from each other.
 */
const SCALE_ANCHORS =
  "For scale, use what is in the photo: an exterior door is about 36 inches (0.9 m) wide, a railing is 36 to 42 inches (1 m) tall with its pickets about 4 inches (10 cm) apart, a lounge chair is about 6 feet (1.8 m) long. Image 2 is a small sample, not the whole floor: a typical deck floor is two to four roll widths across and shows the pattern repeated many times, across the deck floor only.";
