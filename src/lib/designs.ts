...
export const DESIGNS: Design[] = [
  ...
  },
  {
    ...
    scaleHint: "In this design the chevron boards are about 3.5 inches (9 cm) wide and a straight spine board runs every 18 inches (45 cm), so a 12 foot wide deck shows about 8 spines with chevrons between them. The boards are a uniform weathered grey-brown with crisp joints between them.",
