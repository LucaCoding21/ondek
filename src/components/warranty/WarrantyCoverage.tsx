      ...
      <div className="w-full px-5 md:px-8 lg:px-12 xl:px-16 pt-14 lg:pt-20 pb-32 lg:pb-48">
        ...
        <div className="mt-10 grid gap-14 lg:grid-cols-[minmax(0,8fr)_minmax(0,6fr)] lg:gap-12 xl:gap-16 lg:items-stretch">
          <Reveal className="flex flex-col">
            <h2 className="max-w-2xl font-bold leading-[1.08] tracking-[-0.02em] text-[clamp(2.25rem,3.6vw,3.5rem)]">
              What the warranty covers.
            </h2>

            <p className="mt-8 max-w-2xl text-foreground/60 leading-relaxed">
              OnDek Vinyl Worx is pleased to offer our customers a 15 Year
              Waterproofing / 5 Year Appearance warranty. More than 2 million
            ...
            <div className="relative mt-16 aspect-[16/10] w-full overflow-hidden sm:max-w-lg lg:mt-auto lg:max-w-[34rem]">
              <Image
          ...
          <Reveal stagger=".coverage-entry" className="flex flex-col gap-16 lg:gap-24 lg:max-w-[46rem]">
            {ENTRIES.map((entry, i) => (
              <div key={entry.title} className="coverage-entry">
