          ...
          <div className="relative h-full">
            ...
            <div className="relative z-10 flex h-full items-end">
              <div className="w-full px-6 sm:px-12 lg:px-16 pb-12 lg:pb-16">
                <div className="grid gap-10 lg:grid-cols-[3fr_2fr] lg:gap-16 lg:items-end">
                  <h1 className="hero-line text-4xl sm:text-5xl xl:text-6xl font-bold leading-[1.02] tracking-[-0.02em] text-balance text-white">
                    Waterproof decking, built to last.
                  </h1>

                  <div className="text-white lg:pb-1 lg:ml-auto lg:max-w-md">
                    <p className="hero-line text-base text-white/85 leading-relaxed">
